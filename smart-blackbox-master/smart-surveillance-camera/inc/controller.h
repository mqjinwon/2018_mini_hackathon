...
#define SERVO_MOTOR_VERTICAL_MIN 0		//20
#define SERVO_MOTOR_VERTICAL_MAX 0		//45
#define SERVO_MOTOR_VERTICAL_CENTER ((SERVO_MOTOR_VERTICAL_MIN + SERVO_MOTOR_VERTICAL_MAX) / 2)
#define SERVO_MOTOR_HORIZONTAL_MIN -17//20
#define SERVO_MOTOR_HORIZONTAL_MAX 100//95
